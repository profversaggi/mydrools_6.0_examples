 ...
 * in a nutshell.
 * 
 * We are now going to process both credits and debits on two bank accounts, calculating 
 * the account balance. In order to do this, we create two separate Account objects and 
 * inject them into the Cashflows objects before passing them to the Rule Engine. The reason 
 * for this is to provide easy access to the correct account without having to resort to 
 * helper classes.
 * 
...
public class BankingExample6 {
    public static void main(String[] args) {
        ...
        Account acc1 = new Account(1);      // Create 2 new account objects
        Account acc2 = new Account(2);
           
        Object[] cashflows = {
                
            // Create 10 new AllocatedCashflow objects, store them in an array Object[] cashflows.
        ...
        new RuleRunner().runRules( new String[] { "Example6.drl" }, cashflows );  // Insert Data and rule into WM.
    }
    
}// End Class BankingExample6
