...
/**
 * This is a simple class to extend the Cashflow class, using Constants for CREDIT, DEBIT,
 * and the usual constructors, setters and getters.
 */
